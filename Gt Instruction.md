...
Для получения информации о ветках пропишем команду **а в вот этой строчке замутим конфликт для того, чтобы гит понял, что без юзера не справится и заплакал**
